    ...
    <main class="max-w-10xl mx-auto mt-8 lg:mt-20 space-y-8">
        <div class="flex items-center justify-center min-h-screen bg-gray-200">
            <div class="w-full px-8 py-16 bg-white rounded-lg shadow-2xl lg:w-2/5">
                ...
                <div id="sendus_form" class="mx-8 space-y-8">
                    {{ csrf_field() }}
                    <div>
                    ...
                    <div>
                        <input type="text" id="email" name="email" class="w-full p-2 text-sm border-b-2 border-gray-400 outline-none opacity-50 focus:border-blue-400"
                            placeholder="Your Email *" />
                        {{-- <span class="text-xs text-red-600">Email field required</span> --}}
                    </div>
                    <div>
                        <input type="text" id="subject" name="subject" class="w-full p-2 text-sm border-b-2 border-gray-400 outline-none opacity-50 focus:border-blue-400"
                            placeholder="Subject *" />
                    </div>
                    <div>
                        <textarea name="message" id="message" class="w-full p-6 text-sm border-b-2 border-gray-400 rounded-lg outline-none opacity-50 focus:border-blue-400" placeholder="Enter your message *"></textarea>
                    </div>
                    <button id="sendus_submit" class="block w-full px-2 py-4 mt-2 text-white bg-black rounded-full">Send Form</button>
                </div>
            </div>
        </div>
    </main>
        ...
        <footer class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    <div id="subscribe_form" class="lg:flex text-md">
                        ...
                        <button type="submit" id="subscribe_submit" class="transition-colors duration-300 bg-blue-500 hover:bg-blue-600 mt-4 lg:mt-0 lg:ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-8">
                            Subscribe
                        </button>
                    </div>
